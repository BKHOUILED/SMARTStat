  ...
  sidebarLayout(
    sidebarPanel(
      ...
      conditionalPanel(
        ...
        textInput("sample_onemean", "Sample", value = "10, 20, 30", placeholder = "Enter values separated by a comma"),
        hr(),
      ...
      conditionalPanel(
        ...
        textInput("sample1_twomeans", "Sample 1", value = "10, 20, 30", placeholder = "Enter values separated by a comma"),
        textInput("sample2_twomeans", "Sample 2", value = "15, 25, 35", placeholder = "Enter values separated by a comma"),
        hr(),
        conditionalPanel(
      ...
      conditionalPanel(
        ...
        textInput("sample_onevar", "Sample", value = "10, 20, 30", placeholder = "Enter values separated by a comma")
      ),
      conditionalPanel(
        condition = "input.inference == 'two variances'",
        textInput("sample1_twovar", "Sample 1", value = "10, 20, 30", placeholder = "Enter values separated by a comma"),
        textInput("sample2_twovar", "Sample 2", value = "15, 25, 35", placeholder = "Enter values separated by a comma")
      ),
      hr(),
      ...
      HTML('<a rel="license" href="https://creativecommons.org/licenses/by/4.0/deed.ar" target="_blank"><img alt="Licence Creative Commons" style="border-width:0"
        ...
        href="license" href="https://creativecommons.org/licenses/by/4.0/deed.ar" target="_blank">CC BY 4.0</a>. Source code available <a href="https://github.com/BKHOUILED/SMARTStat" target="_blank">here</a>.')
    ),
...
# Define server logic required to run the tests
server <- function(input, output) {
  ...
  # generate test based on input$sample from ui.R
  output$results_onemean <- renderUI({
    ...
    if (anyNA(dat) | length(dat) < 2) {
      ...
      withMathJax(
        paste(c("My data:", paste(dat, collapse = ", ")), collapse = " "),
        br(),
        paste0("\\(n =\\) ", length(dat)),
        br(),
